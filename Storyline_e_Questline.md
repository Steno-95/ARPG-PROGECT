il giocatore entra in locandaMaestro:

- E' giunta l'ora…\\n[1]
- E' ora che anche tu intraprenda il percorso per diventare un avventuriero… parla con la ragazza al bancone perfarti introdurre al regolamento…
...
| ID | l'id della quest da usare all'interno del database delle quest (Quest.json) |
|----|-----------------------------------------------------------------------------|
