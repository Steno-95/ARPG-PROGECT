...
\- E' ora che anche tu intraprenda il percorso per diventare un avventuriero… parla con la ragazza al bancone per

&#x20;farti introdurre al regolamento…



Dialogo con l'Addetta alla reception della gilda che spiega il funzionamento delle quest secondarie,

che possono essere ottenute dal tabellone in caso di missioni secondarie o ripetibili e eventualmente in casi speciali
...
ti spiega che non ci sono disponibili missioni per il tuo rango e che ti merita provare con il cartellone o sentire

il tuo maestro



(Il maestro rifiuterà di assegnarti la quest della cantina fino al completamento di tutte le quest secondarie sul
...
Scena iniziale con personaggio neonato salvato dal eroe/maestro che lo salva nel bosco durante una missione.
...
\- (1maestro,1 per negozio(con 1 o 2 acquirenti)

\- 4 lavorare al magazzino

\- gilda piano superiore 1 per stanza
...
&#x20;e 1 nella parte più alta della torre) fatto rapporto l apprendista rimarrà  con il nostro eroe nel party, come seconda missione
...
|**NOME VARIABILI**|**DEFINIZIONE SCOPO VARIABILE**|
|-|-|
|0061 Maestro Intro III Quest Count|Incrementa da 0 a 3 fino al completamento di tutte le quest secondarie necessarie a proseguire la quest del maestro|
